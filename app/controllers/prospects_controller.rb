class ProspectsController < ApplicationController
  ...
  private
    ...
    def prospect_params
      params.require(:prospect).permit(:date, :codepostal, :ville, :adresse, :genre, :nom, :prenom, :mail, :tel1, :tel2, :tel3, :mobile, :fax, :site, :comment, :activite, :habitat, :agemoyen, :tel1prospection, :tel2prospection, :tel3prospection, :mobileprospection, :faxprospection)
    end
end
